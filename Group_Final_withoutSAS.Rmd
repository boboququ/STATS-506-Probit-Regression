...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/data1.png){width=500px}
...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/data2.png){width=500px}
...
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out1.png){width=500px}
...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out2.png){width=500px}
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out3.png){width=500px}
...
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out4-2.png){width=500px}
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out4-3.png){width=500px}
...
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out5-1.png){width=500px}
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out5-2.png){width=500px}
...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/m_wc.png){width=500px}
In this plot, actually we only need the 2 points on the curve: where wc=0 and wc=1.
...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/m_hc.png){width=500px}
In this plot, actually we only need the 2 points on the curve: where hc=0 and hc=1.
...
run;
```
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out7.png){width=500px}
The code above also creates several plots for model diagnosis: 
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out6-1.png){width=500px}
![](https://raw.githubusercontent.com/boboququ/STATS-506-Probit-Regression/tree/master/SAS/sas_outs/sas_out6-2.png){width=500px}
...
- UCLA Probit Regression in R :  https://stats.idre.ucla.edu/r/dae/probit-regression/
